...
namespace Paradigm.ORM.Data.MySql
{
    ...
    internal partial class MySqlDatabaseReader : IDatabaseReader
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MySqlDatabaseReader"/> class.
        /// </summary>
        /// <param name="reader">The reader.</param>
        /// <exception cref="System.ArgumentNullException">reader can not be null.</exception>
        internal MySqlDatabaseReader(MySqlDataReader reader)
        {
        ...
        {
            return (TimeSpan)this.Reader.GetValue(index);
        }
