...
namespace Paradigm.ORM.DataExport.Export
{
    ...
    internal class CustomColumnDescriptor : IColumnDescriptor
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomColumnDescriptor"/> class.
        /// </summary>
        /// <param name="column">The column schema.</param>
        /// <param name="constraints">The constraints schema.</param>
        internal CustomColumnDescriptor(IColumn column, IEnumerable<IConstraint> constraints)
        {
            this.Column = column;
