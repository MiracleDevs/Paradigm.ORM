...
namespace Paradigm.ORM.Data.SqlServer
{
    ...
    internal partial class SqlDatabaseReader : IDatabaseReader
    {
        #region Properties
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqlDatabaseReader"/> class.
        /// </summary>
        /// <param name="reader">The reader.</param>
        /// <exception cref="System.Exception">reader</exception>
        internal SqlDatabaseReader(SqlDataReader reader)
        {
            this.Reader = reader ?? throw new Exception(nameof(reader));
        }
