...
{
    /// <summary>
    /// Provides an interface to execute data reader stored procedures returning only 4 result sets.
    /// </summary>
    /// <remarks>
    ...
    public partial interface IReaderStoredProcedure<in TParameters, TResult1, TResult2, TResult3, TResult4> : IRoutine
    {
        /// <summary>
        ...
        Tuple<List<TResult1>, List<TResult2>, List<TResult3>, List<TResult4>> Execute(TParameters parameters);
    }
}