...
namespace Paradigm.ORM.Data.StoredProcedures
{
            ...
            IReaderStoredProcedure<TParameters, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ReaderStoredProcedure{TParameters, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8}"/> class.
        /// </summary>
        /// <param name="serviceProvider">The service provider.</param>
        /// <param name="connector">The database connector.</param>
        ...
        /// List of tuples.
        /// </returns>
        public Tuple<List<TResult1>, List<TResult2>, List<TResult3>, List<TResult4>, List<TResult5>, List<TResult6>, List<TResult7>, Tuple<List<TResult8>>> Execute(TParameters parameters)
        {
            if (parameters == null)
            ...
            return new Tuple<List<TResult1>, List<TResult2>, List<TResult3>, List<TResult4>, List<TResult5>, List<TResult6>, List<TResult7>, Tuple<List<TResult8>>>(result1, result2, result3, result4, result5, result6, result7, new Tuple<List<TResult8>>(result8));
        }
        ...
        protected void Initialize()
        {
            ...
            this.Mapper3 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult3>>(() => new DatabaseReaderMapper<TResult3>(this.Connector));
            this.Mapper4 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult4>>(() => new DatabaseReaderMapper<TResult4>(this.Connector));
            this.Mapper5 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult5>>(() => new DatabaseReaderMapper<TResult5>(this.Connector));
            this.Mapper6 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult6>>(() => new DatabaseReaderMapper<TResult6>(this.Connector));
            this.Mapper7 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult7>>(() => new DatabaseReaderMapper<TResult7>(this.Connector));
            this.Mapper8 ??= this.ServiceProvider.GetServiceIfAvailable<IDatabaseReaderMapper<TResult8>>(() => new DatabaseReaderMapper<TResult8>(this.Connector));
