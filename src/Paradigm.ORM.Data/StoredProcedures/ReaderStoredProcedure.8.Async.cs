...
namespace Paradigm.ORM.Data.StoredProcedures
{
    public partial class ReaderStoredProcedure<TParameters, TResult1, TResult2, TResult3, TResult4, TResult5, TResult6, TResult7, TResult8>
    {
        ...
        /// List of tuples.
        /// </returns>
        public async Task<Tuple<List<TResult1>, List<TResult2>, List<TResult3>, List<TResult4>, List<TResult5>, List<TResult6>, List<TResult7>, Tuple<List<TResult8>>>> ExecuteAsync(TParameters parameters)
        {
            if (parameters == null)
            ...
            await reader.NextResultAsync();
            var result7 = await this.Mapper7.MapAsync(reader);
            await reader.NextResultAsync();
            var result8 = await this.Mapper8.MapAsync(reader);
