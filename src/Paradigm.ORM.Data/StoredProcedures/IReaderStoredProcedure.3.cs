...
{
    /// <summary>
    /// Provides an interface to execute data reader stored procedures returning only 3 result sets.
    /// </summary>
    /// <remarks>
    ...
    public partial interface IReaderStoredProcedure<in TParameters, TResult1, TResult2, TResult3> : IRoutine
    {
        ...
        Tuple<List<TResult1>, List<TResult2>, List<TResult3>> Execute(TParameters parameters);
    }
}