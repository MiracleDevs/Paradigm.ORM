...
namespace Paradigm.ORM.Data.Logging
{
    ...
    public class DefaultLogProvider: ILogProvider
    {
        ...
        {
            Debug.Write($"[{DateTime.Now:yy-MM-dd hh:mm:ss}][INFO] - {message}");
        }

        public void Warning(string message)
        {
            Debug.Write($"[{DateTime.Now:yy-MM-dd hh:mm:ss}][WARN] - {message}");
        }

        public void Error(string message)
        {
            Debug.Write($"[{DateTime.Now:yy-MM-dd hh:mm:ss}][ERROR] - {message}");
        }
    }
}