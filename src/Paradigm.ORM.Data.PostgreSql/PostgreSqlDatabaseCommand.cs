...
namespace Paradigm.ORM.Data.PostgreSql
{
    ...
    internal partial class PostgreSqlDatabaseCommand : IDatabaseCommand
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgreSqlDatabaseCommand"/> class.
        /// </summary>
        ...
        internal PostgreSqlDatabaseCommand(NpgsqlCommand command, PostgreSqlDatabaseConnector connector)
        {
