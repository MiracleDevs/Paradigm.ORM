...
namespace Paradigm.ORM.Tests.Tests.Schemas.Cql
{
    public class SchemaTest
    {
        ...
        public void ShouldRetrieveAllTables()
        {
            ...
            schemaProvider.Invoking(x => tables = x.GetTables(this.Fixture.GetDatabaseName())).Should().NotThrow();
        ...
        public void ShouldFilterTheTables()
        {
            ...
            schemaProvider.Invoking(x => tables = x.GetTables(this.Fixture.GetDatabaseName(), "table1")).Should().NotThrow();
            tables.Should().NotBeNull();
        ...
        public void ShouldRetrieveColumns()
        {
            ...
            schemaProvider.Invoking(x => columns = x.GetColumns(this.Fixture.GetDatabaseName(), "table1")).Should().NotThrow();
            ...
            schemaProvider.Invoking(x => columns = x.GetColumns(this.Fixture.GetDatabaseName(), "table3")).Should().NotThrow();
        ...
        public void ShouldRetrieveConstraints()
        {
            ...
            schemaProvider.Invoking(x => constraints = x.GetConstraints(this.Fixture.GetDatabaseName(), "table1")).Should().NotThrow();
            ...
            schemaProvider.Invoking(x => constraints = x.GetConstraints(this.Fixture.GetDatabaseName(), "table2")).Should().NotThrow();
            ...
            schemaProvider.Invoking(x => constraints = x.GetConstraints(this.Fixture.GetDatabaseName(), "table3")).Should().NotThrow();
        ...
        public void ShouldntRetrieveStoredProcedures()
        {
            ...
            schemaProvider.Invoking(x => storedProcedures = x.GetStoredProcedures(this.Fixture.GetDatabaseName())).Should().NotThrow();
        ...
        public void ShouldntRetrieveParameters()
        {
            ...
            schemaProvider.Invoking(x => parameters = x.GetParameters(this.Fixture.GetDatabaseName(), "StoredProcedure")).Should().NotThrow();
