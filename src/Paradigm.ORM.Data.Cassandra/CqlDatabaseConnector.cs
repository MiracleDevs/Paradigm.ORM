...
using Paradigm.ORM.Data.Cassandra.CommandBuilders;
using Paradigm.ORM.Data.Cassandra.Converters;
using Paradigm.ORM.Data.Cassandra.Schema;
...
{
    /// <summary>
    /// Provides a connection to a Cql Server database.
    /// </summary>
    /// <seealso cref="Paradigm.ORM.Data.Database.IDatabaseConnector" />
    public partial class CqlDatabaseConnector : IDatabaseConnector
    {
        #region Properties
        ...
        /// </value>
        internal CqlDatabaseTransaction ActiveTransaction => this.Transactions.Any() ? this.Transactions.Peek() : null;
        ...
        /// The connection.
        /// </value>
        private CqlConnection Connection { get; set; }
        ...
        /// The value provider.
        /// </value>
        private Lazy<CqlDbTypeValueRangeProvider> ValueProvider { get; set; }
        ...
        /// The transactions.
        /// </value>
        private Stack<CqlDatabaseTransaction> Transactions { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CqlDatabaseConnector"/> class.
        /// </summary>
        public CqlDatabaseConnector()
        {
            this.Initialize();
        }
        ...
        public CqlDatabaseConnector(string connectionString)
        {
        ...
        /// </summary>
        /// <returns>
        /// A new <see cref="CqlDatabaseTransaction">transaction</see>.
        /// </returns>
        ...
        public IDatabaseTransaction CreateTransaction(IsolationLevel isolationLevel)
        {
            ...
            {
                var transaction = new CqlDatabaseTransaction(this.Connection.BeginTransaction(isolationLevel) as CqlBatchTransaction, this);
        ...
        /// </summary>
        /// <returns>
        /// A new <see cref="CqlDatabaseCommand">command</see>.
        /// </returns>
        ...
        public IDatabaseCommand CreateCommand()
        {
            ...
            return this.ThrowIfFails<OrmConnectorException, IDatabaseCommand>(() =>
            {
                ...
                return new CqlDatabaseCommand(command as CqlCommand, this);
        ...
        /// </remarks>
        /// <see cref="CqlCommandBuilderFactory"/>
        ...
        /// </remarks>
        /// <see cref="CqlCommandFormatProvider"/>
        ...
        /// </summary>
        /// <exception cref="System.Exception">Cql Connection is not initialized.</exception>
