...
namespace Paradigm.ORM.Data.Cassandra
{
    ...
    internal partial class CqlDatabaseCommand : IDatabaseCommand
    {
        ...
        /// <summary>
        /// Gets or sets the internal CqlCommand instance.
        /// </summary>
        private CqlCommand Command { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CqlDatabaseCommand"/> class.
        /// </summary>
        ...
        internal CqlDatabaseCommand(CqlCommand command, CqlDatabaseConnector connector)
        {
