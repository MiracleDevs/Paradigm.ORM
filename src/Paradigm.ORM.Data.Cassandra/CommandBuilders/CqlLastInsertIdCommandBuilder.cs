...
namespace Paradigm.ORM.Data.Cassandra.CommandBuilders
{
    ...
    public class CqlLastInsertIdCommandBuilder: ILastInsertIdCommandBuilder
    {
        #region Columns
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CqlLastInsertIdCommandBuilder"/> class.
        /// </summary>
        /// <param name="connector">The database connector.</param>
        public CqlLastInsertIdCommandBuilder(IDatabaseConnector connector)
        {
        ...
        {
            this.Command = this.Connector.CreateCommand("SELECT LAST_INSERT_ID()");
        }
